...
net_config = {
    ...
    'layers': {
        'fc8': { 'blob_name': 'fc8', 'layer_name': 'fc8', 'idx': 8 },
        'fc7': { 'blob_name': 'fc7', 'layer_name': 'relu7', 'idx': 7 },
        'fc6': { 'blob_name': 'fc6', 'layer_name': 'relu6', 'idx': 6 },
        'conv5': { 'blob_name': 'conv5', 'layer_name': 'relu5', 'idx': 5 },
        'conv4': { 'blob_name': 'conv4', 'layer_name': 'relu4', 'idx': 4 },
